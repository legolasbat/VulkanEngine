...
cvPipeline::cvPipeline(cvDevice &device, const std::string &vertFilepath,
...
std::vector<char> cvPipeline::readFile(const std::string &filepath) {
...
void cvPipeline::createGraphicsPipeline(const std::string &vertFilepath,
                                        const std::string &fragFilepath,
                                        const PipelineConfigInfo &configInfo) {
...
void cvPipeline::createShaderModule(const std::vector<char> &code,
...
void cvPipeline::bind(VkCommandBuffer commandBuffer) {
  vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS,
                    graphicsPipeline);
}

void cvPipeline::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo) {
...
void cvPipeline::enableAlphaBlending(PipelineConfigInfo &configInfo) {
