...
VkResult cvSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult cvSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                           uint32_t *imageIndex) {
...
void cvSwapChain::createSwapChain() {
...
void cvSwapChain::createImageViews() {
...
void cvSwapChain::createRenderPass() {
...
void cvSwapChain::createFramebuffers() {
...
void cvSwapChain::createDepthResources() {
...
void cvSwapChain::createSyncObjects() {
...
VkSurfaceFormatKHR cvSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR cvSwapChain::chooseSwapPresentMode(
...
VkExtent2D
cvSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat cvSwapChain::findDepthFormat() {
