 ...
 */
VkDeviceSize cvBuffer::getAlignment(VkDeviceSize instanceSize,
...
cvBuffer::cvBuffer(cvDevice &device, VkDeviceSize instanceSize,
 ...
 * @return VkResult of the buffer mapping call
 */
VkResult cvBuffer::map(VkDeviceSize size, VkDeviceSize offset) {
 ...
 */
void cvBuffer::writeToBuffer(void *data, VkDeviceSize size,
                             VkDeviceSize offset) {
 ...
 */
VkResult cvBuffer::flush(VkDeviceSize size, VkDeviceSize offset) {
 ...
 */
VkResult cvBuffer::invalidate(VkDeviceSize size, VkDeviceSize offset) {
  VkMappedMemoryRange mappedRange = {};
  mappedRange.sType = VK_STRUCTURE_TYPE_MAPPED_MEMORY_RANGE;
  mappedRange.memory = memory;
  mappedRange.offset = offset;
 ...
 */
VkDescriptorBufferInfo cvBuffer::descriptorInfo(VkDeviceSize size,
                                                VkDeviceSize offset) {
 ...
 */
void cvBuffer::writeToIndex(void *data, int index) {
 ...
 * @param index Used in offset calculation
 */
VkResult cvBuffer::flushIndex(int index) {
 ...
 */
VkDescriptorBufferInfo cvBuffer::descriptorInfoForIndex(int index) {
 ...
 * @return VkResult of the invalidate call
 */
VkResult cvBuffer::invalidateIndex(int index) {
